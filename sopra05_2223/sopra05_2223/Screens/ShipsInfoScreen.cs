...
{
    internal sealed class ShipsInfoScreen : IScreen
    {
        ...
        public ShipsInfoScreen(Point screenSize)
        {
        ...
        private void NextScreenButton_Click(object sender, EventArgs e)
        {
            ...
            ScreenManager.AddScreen(new ControlsHelpScreen(mScreenSize));
        }
        ...
        void IScreen.Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Art.ShipsInfoScreenBackground, new Rectangle(0, 0, mScreenSize.X, mScreenSize.Y), new Rectangle(0, 0, Art.ShipsInfoScreenBackground.Width, Art.ShipsInfoScreenBackground.Height), Color.White);
