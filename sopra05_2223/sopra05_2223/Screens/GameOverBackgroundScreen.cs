...
namespace sopra05_2223.Screens
{
    ...
    internal class GameOverBackgroundScreen : IScreen
    {
        ...
        public GameOverBackgroundScreen(Point screenSize)
        {
        ...
        void IScreen.Update(Input input)
        {
            ...
            {
                mElapsed -= 300;
                Art.AnimationManager.AddAnimation(new Explosion2(new Vector2(Globals.RandomNumber() % mScreenSize.X, Globals.RandomNumber() % mScreenSize.Y), 0.5f));
            }
        ...
        void IScreen.Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Art.GameOverBackground, new Rectangle(0, 0, mScreenSize.X, mScreenSize.Y), new Rectangle(0, 0,Art.GameOverBackground.Width,Art.GameOverBackground.Height  ), Color.White);
            spriteBatch.End();
            spriteBatch.Begin();
