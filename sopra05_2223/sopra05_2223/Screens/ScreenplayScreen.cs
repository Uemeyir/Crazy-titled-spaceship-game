...
{
    internal sealed class ScreenplayScreen : IScreen
    {
        ...
        public ScreenplayScreen(Point screenSize)
        {
        ...
        void IScreen.Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Art.ScreenplayScreenBackground, new Rectangle(0, 0, mScreenSize.X, mScreenSize.Y), new Rectangle(0, 0, Art.ScreenplayScreenBackground.Width, Art.ScreenplayScreenBackground.Height), Color.White);
